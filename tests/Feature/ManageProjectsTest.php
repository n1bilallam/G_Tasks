...
class ManageProjectsTest extends TestCase
{
    ...
    {
        $project = factory('Birdbord\Project')->create();
    ...
    /** @test */
    function a_user_can_see_all_projects_the_have_been_invited_to_on_their_dashboard(){
    ...
    {
        $this->signIn();
        $attributes = factory('Birdbord\Project')->raw(['title' => '']);
    ...
    {
        $this->signIn();
        $attributes = factory('Birdbord\Project')->raw(['description' => '']);
